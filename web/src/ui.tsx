...
const P: Record<string, string> = {
  ...
  notes: '<path d="M15.5 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V8.5z"/><path d="M15 3v6h6"/><path d="M8 13h6"/><path d="M8 17h4"/>',
  ...
  coffee: '<path d="M10 2v2"/><path d="M14 2v2"/><path d="M16 8a1 1 0 0 1 1 1v8a4 4 0 0 1-4 4H7a4 4 0 0 1-4-4V9a1 1 0 0 1 1-1z"/><path d="M6 2v2"/><path d="M16 8h2a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2h-2"/>',
...
export const ICON_NAMES = ['globe', 'rocket', 'folder', 'code', 'terminal', 'server', 'cloud', 'database',
  'shield', 'key', 'mail', 'calendar', 'chart', 'cart', 'box', 'image', 'video', 'music', 'phone',
  'message', 'bookmark', 'file', 'play', 'camera', 'map', 'zap', 'coffee', 'briefcase', 'cpu', 'bot',
  'star', 'heart', 'layers', 'home', 'wrench', 'github', 'bell', 'power']
...
export function Icon({ name, size = 18, className = '' }: { name: string; size?: number; className?: string }) {
  return (
    <svg className={'ic ' + className} width={size} height={size} viewBox="0 0 24 24" fill="none"
      ...
      dangerouslySetInnerHTML={{ __html: P[name] || P.globe }} />
  )
}

export function Spinner({ big = false }: { big?: boolean }) { return <span className={'spinner' + (big ? ' big' : '')} /> }

export function Modal({ title, onClose, children }: { title: string; onClose: () => void; children: React.ReactNode }) {
  return (
    <div className="modal-back" onMouseDown={onClose}>
      <div className="modal glass" onMouseDown={e => e.stopPropagation()} role="dialog" aria-modal>
        <div className="modal-head"><h3>{title}</h3>
          <button className="icon-btn sm" onClick={onClose} aria-label="Close"><Icon name="x" /></button></div>
